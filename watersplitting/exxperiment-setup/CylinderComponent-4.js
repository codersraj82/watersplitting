...
export class CylinderComponent {
  ...
  createCylinders() {
    ...
    this.cylinderMesh1.add(label1Top);
    this.cylinderMesh1.add(label1Bottom);
    ...
    this.cylinderMesh2.add(label2Top);
    this.cylinderMesh2.add(label2Bottom);

...
import { World, Body, Plane, Vec3, Cylinder } from "cannon-es";
import CylinderComponent from "../CylinderComponent"; // Update the path accordingly
...
// Instantiate and integrate the CylinderComponent
const cylinderComponent = new CylinderComponent();

// Place the cylinder component inside the jar at the bottom
cylinderComponent.cylinderGroup.position.set(0, -0.5, 0); // Adjust position as needed
scene.add(cylinderComponent.scene);
...
function animate() {
  ...
  // Sync cylinder component
  cylinderComponent.animate(); // Make sure this method updates cylinderComponent’s scene if needed

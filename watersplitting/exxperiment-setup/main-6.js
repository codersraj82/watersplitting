...
const whiteMaterial = new THREE.MeshStandardMaterial({ color: 0xffffff }); // White solid material

const cylinderMesh1 = new THREE.Mesh(cylinderGeometry, whiteMaterial);
...
const cylinderMesh2 = new THREE.Mesh(cylinderGeometry, whiteMaterial);
...
cylinderGroup.rotation.z = Math.PI / 2; // Rotate the group by 90 degrees (π/2 radians)

// Place the cylinder group above the ground
cylinderGroup.position.set(0, 1, 0); // Adjust the y position to 1 unit above the ground

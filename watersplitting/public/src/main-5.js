...
// Function to create a straight hollow glass tube
// Function to create a straight hollow glass tube with increased thickness
// Create thick hollow straight tube
...
function moveYBubbleAlongPath(ybubble, pathStart, pathEnd, speed) {
  ...
  if (ybubble.position.distanceTo(pathEnd) < 0.1) {
...
function updateYBubbles() {
  const pathStart = new THREE.Vector3(-3, 0.5, 0); // Starting position of the path
  const pathEnd = new THREE.Vector3(3, 0.5, 0); // End position of the path
